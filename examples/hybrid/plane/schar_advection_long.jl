...
function rhs_invariant!(dY, Y, _, t)
  ...
  f_upwind_product3 = Operators.Upwind3rdOrderBiasedProductC2F(
    ...
    κ₄_dynamic = hyperdiffusivity * 0 # m^4/s
    ...
    #@. dρe -= vdivf2c(Ic2f(cρ) * fw * Ic2f((cρe + cp)/cρ))
    # @. dρe -= vdivf2c(Ic2f(cρ) * fw * Ic2f((cρe + cp)/cρ)) # WRONG ANSWER! 
...
dir = "tracer_mountain_advection_long"
